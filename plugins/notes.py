...
url['readme_heroku'] = (
    "https://github.com/OnlyFaris/xluamusic#deploy-to-heroku"
)
url['heroku'] = (
    "https://heroku.com/deploy?template="
    "https://github.com/OnlyFaris/xluamusic/tree/main"
)
...
url['repo'] = "https://github.com/OnlyFaris/xluamusic"
notes['repo'] = f"""{emoji.LABEL} **Repository** (/notes #repo):

{emoji.ROBOT} [Telegram Voice Chat Userbot (xluamusic)]({url['repo']})"""

url['tmbh'] = (
    "https://heroku.com/deploy?template="
    "https://github.com/OnlyFaris/tgmusicbot"
)
notes['musicbot'] = (
    f"""{emoji.ROBOT} **Telegram Music Bot** (/notes #musicbot):
__bot for downloading music from YouTube/SoundCloud/Mixcloud__

**Repository**: [GitHub](https://github.com/OnlyFaris/tgmusicbot)
